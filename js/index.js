...
$(document).ready(function() {
    // 教师卡片滚动效果
    $('.teachers-container').on('mousedown', function(e) {
        var startX = e.pageX;
        var scrollLeft = $(this).scrollLeft();
        var $this = $(this);
        
        $(document).on('mousemove.teacherScroll', function(e) {
            var x = e.pageX - startX;
            $this.scrollLeft(scrollLeft - x);
        });
        
        $(document).on('mouseup.teacherScroll', function() {
            $(document).off('mousemove.teacherScroll mouseup.teacherScroll');
        });
    });
